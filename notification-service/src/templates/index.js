...
function getTicketConfirmationTemplate(ticketData) {
  ...
  return `
    ...
    ">
      ...
      <p style="font-size: 14px; color: #888; text-align: center;">
        Safe Journey! 🚂<br/>
        <strong>Team TrainTravel</strong>
      </p>
    </div>
  `;
}
...
const CANCELLATION_REASON_MESSAGES = {
  ...
  schedule_cancelled: 'The train schedule for this booking was cancelled by TrainTravel.',
};
...
function getBookingFailedTemplate(data) {
  ...
  return `
    ...
    ">
      ...
      <p style="font-size: 15px; color: #555;">
        If any amount was debited, it will be refunded to your original payment method automatically. You can try booking again from your TrainTravel account.
      </p>
